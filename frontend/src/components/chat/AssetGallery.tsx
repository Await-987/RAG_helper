  ...
  return (
    <div className="mt-4 pt-3 border-t border-zinc-800">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs font-medium text-zinc-400">表格图片</span>
      </div>
      <div className="space-y-4">
        {normalizedAssets.map((asset, index) => (
          <div key={`${asset.asset_tag}-${index}`} className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-3">
